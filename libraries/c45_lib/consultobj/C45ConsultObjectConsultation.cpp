...
void C45ConsultObject::ClassifyCase( Tree Subtree, float Weight )
  /*  ------------ 	 */
{
  DiscrValue v;
  float BranchWeight;
...
float C45ConsultObject::Interpolate( Tree t, float v )
  /*    ---- 	 */
{
  //    float Sum=Epsilon;
...
float C45ConsultObject::Area( Tree t, float v )
  /*    ---- 	 */
{
  float Sum=Epsilon, F;
...
void C45ConsultObject::InterpretTree()
  /*  ------------- 	 */
{ 
  ClassNo c, BestClass;
...
void C45ConsultObject::Decision( ClassNo c, float p, float lb, float ub)
  /*  -------- 	 */
{
